...
import sys
sys.path.append('.')
from aloha_data.conversion_utils import MultiThreadedDatasetBuilder
...
class AlohaData(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/groups/gag51454/workspace_kitagawa/data/preprocessed/*/train/*.hdf5"),
            "val": glob.glob("/groups/gag51454/workspace_kitagawa/data/preprocessed/*/val/*.hdf5"),
        }
