...
import sys
sys.path.append('.')
from aloha_sample.conversion_utils import MultiThreadedDatasetBuilder
...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(episode_path):
        ...
        border = episode_path.find("preprocessed/")
        csv_path = episode_path[:border+13] + "aloha_task_list.csv"
        csv_data = np.loadtxt(csv_path, delimiter=",", skiprows=1, usecols=(1,2), dtype="unicode")
        task_list = dict(csv_data)
        command = task_list[raw_file_string]
...
class AlohaSample(MultiThreadedDatasetBuilder):
    ...
    N_WORKERS = 0              # number of parallel workers for data conversion
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/home/y_kitagawa/デスクトップ/openvla/openvla/data/preprocessed/block_delivery/train/*.hdf5") + glob.glob("/home/y_kitagawa/デスクトップ/openvla/openvla/data/preprocessed/cable_routing_8pin_cross/train/*.hdf5"),
            "val": glob.glob("/home/y_kitagawa/デスクトップ/openvla/openvla/data/preprocessed/block_delivery/val/*.hdf5") + glob.glob("/home/y_kitagawa/デスクトップ/openvla/openvla/data/preprocessed/cable_routing_8pin_cross/val/*.hdf5"),
        }
